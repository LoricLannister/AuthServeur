...
var SessionValidator = function () {
   ...
   *
   */
  function SessionValidator(options) {
    _classCallCheck(this, SessionValidator);

    var internalOptions = { check_frequency: 10 };
      ...
      jQuery(function () {
        ...
        var sessionCheck = function sessionCheck() {
          ...
          jQuery.get($this.validate_url, function (data) {
            ...
            console.log('an error occurred monitoring the session, stopping, ' + 'trying again in 60 seconds');
            $this.stop();
            setTimeout(function () {
            ...
            $this.intervalId = setTimeout(sessionCheck, $this.check_frequency * 1000);
          });
        };
